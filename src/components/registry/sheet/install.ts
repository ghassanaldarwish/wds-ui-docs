const npm = `
npm install @wds-ui/sheet
`;

const yarn = `
yarn add @wds-ui/sheet
`;

const pnpm = `
pnpm add @wds-ui/sheet
`;
...
const SheetPrimitiveClose = React.forwardRef((props: any, ref: any) => (
  <SheetPrimitive.Close ref={ref} {...props}></SheetPrimitive.Close>
));
